...
<main>
  <div id="CarouselAvecSoustitre" class="carousel slide" data-bs-ride="carousel" >
    <div class="carousel-indicators">
      <button type="button" data-bs-target="#CarouselAvecSoustitre" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
      <button type="button" data-bs-target="#CarouselAvecSoustitre" data-bs-slide-to="1" aria-label="Slide 2"></button>
    </div>

    <button class="carousel-control-prev" type="button" data-bs-target="#CarouselAvecSoustitre" data-bs-slide="prev">
      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
      <span class="visually-hidden">Previous</span>
    </button>

    <button class="carousel-control-next" type="button" data-bs-target="#CarouselAvecSoustitre" data-bs-slide="next">
...
<p>Le service d'ophtalmologie de l'hôpital est l'unité spécialisée dans le diagnostic, le traitement et la gestion des affections liées aux yeux et à la vision. Le service propose des consultations régulières pour les patients qui souhaitent des examens de routine pour évaluer leur vision, la santé de leurs yeux et détecter tout problème potentiel. Les ophtalmologues hospitaliers sont qualifiés pour diagnostiquer et traiter une variété de maladies oculaires telles que la cataracte, le glaucome, la dégénérescence maculaire, les infections oculaires, etc. Les services d'ophtalmologie hospitaliers sont souvent équipés pour réaliser diverses interventions chirurgicales oculaires, y compris la chirurgie de la cataracte, la correction de la vision au laser (LASIK), la chirurgie de rétine, etc. Dans le service nous assurons aussi les soins pédiatriques, les urgences oculaires, la rhéabilitation visuelle. Notre service est aussi impliqué dans la recherche et la formation des futurs ophtalmologues. Au total, notre service offre une gamme complète de soins oculaires, allant des examens de routine aux interventions chirurgicales complexes, avec une approche multidisciplinaire pour assurer la meilleure prise en charge possible des patients. </p>
<p>Le service d'ophtalmologie est spécialisé dans la prise en charge des kératocône.  </p>
...
<div class="row" style="padding:10px;">
  <div class="column_img">
    <img src="ressources/images/progres.png" alt="Progres" style="width :50%;">
  </div>
  <div class="column">
  <h1 style="font-size : 50px">L'équipe</h1>
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem aut ratione nisi temporibus ad dignissimos quam vero qui unde suscipit quod at eius, voluptatem quaerat sed tempora praesentium consectetur molestias pariatur veritatis autem architecto et hic nostrum! Itaque perferendis harum, voluptatibus, ut, modi repudiandae ex nam a aspernatur molestias sit!</p>
    <h2>Lorem 1</h2>
